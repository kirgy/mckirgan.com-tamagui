import { Stack, Image, Text, YStack } from '@my/ui/src'
import CaseStudyTitle from 'app/features/home/caseStudies/CaseStudyTitle'
import { useState } from 'react'
import CONSTANTS from '../../../../../lib/constants'

const bbcMaestroStoreMockup = require('./carescribe-app-screenshot.jpg')
  ...
  return (
    <Stack flex={1} py="$5" space="$5" backgroundColor="#ffffff" ai="center">
      ...
      >
        ...
        <Text color="$gray10Dark" fontFamily="roboto" fontSize={22}>
